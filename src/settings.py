...
class DictPositionMoveBy(enum.StrEnum):
    CHAR = "CHAR"
    WORD = "WORD"
    DISABLED = "DISABLED"


class DictSideBarSide(enum.StrEnum):
    LEFT = "LEFT"
    RIGHT = "RIGHT"


class DictSideBarUpdateOn(enum.StrEnum):
    CLICK = "CLICK"
    DOUBLE_CLICK = "DOUBLE_CLICK"
    HOVER = "HOVER"
...
dict_popup_on_shortcut_move_by = DictPositionMoveBy.WORD
...
dict_side_bar_hover_delay = 500
dict_side_bar_hover_delay_skipped_on_click = True
dict_side_bar_min_width = 3.50
dict_side_bar_on_shortcut_move_by = DictPositionMoveBy.WORD
dict_side_bar_on_shortcut_move_cursor = False
dict_side_bar_position_marker_height = 0.1
dict_side_bar_position_marker_show = False
dict_side_bar_position_marker_width = 0.12
dict_side_bar_text_editor_show = False
dict_side_bar_text_editor_side = DictSideBarSide.RIGHT
dict_side_bar_update_on = DictSideBarUpdateOn.CLICK
...
text_editor_open_side_existing_texts = OpenSide.LEFT_OF_SELECTED
text_editor_open_side_new_texts = OpenSide.RIGHT_OF_SELECTED
...
text_editor_show_font_combo_box = False
...
text_editor_window_default_width_per_view = 7.5
