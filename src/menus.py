...
class Examples(QMenu):
    def __init__(self, window_):
        super().__init__(window_)
        self.addMenu(TranslateTextMenu(window_))
        self.addMenu(CreateEntryMenu(window_))
        self.addMenu(CreateTemplateMenu(window_))
        self.addMenu(SetEntryFormatMenu(window_))
        self.addMenu(SetTagValuesFormatMenu(window_))
        self.addSeparator()
        self.on_update_language()
...
class TranslateTextMenu(QMenu):
    def __init__(self, window_):
        super().__init__(window_)
        self.dictionary_popup = QAction()
        self.dictionary_side_bar = QAction()
        self.addAction(self.dictionary_popup)
        self.addAction(self.dictionary_side_bar)
        self.dictionary_popup.triggered.connect(self.on_dictionary_popup)
        self.dictionary_side_bar.triggered.connect(self.on_dictionary_side_bar)
        self.on_update_language()

    def on_update_language(self):
        self.setTitle(tr("Translate Text"))
        self.dictionary_popup.setText(tr("Dictionary Popup"))
        self.dictionary_side_bar.setText(tr("Dictionary Side Bar"))

    @staticmethod
    def on_dictionary_popup():
        examples.translate_text_dictionary_popup()

    @staticmethod
    def on_dictionary_side_bar():
        examples.translate_text_dictionary_side_bar()
...
class CreateEntryMenu(QMenu):
    def __init__(self, window_):
        ...
        self.mandarin_chinese.triggered.connect(self.on_mandarin_chinese)
...
class SetEntryFormatMenu(QMenu):
    def __init__(self, window_):
        super().__init__(window_)
        self.simple = QAction()
...
class SetTagValuesFormatMenu(SetEntryFormatMenu):
    def __init__(self, window_):
        super().__init__(window_)
