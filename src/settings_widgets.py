...
class DictPopupHideOnChoice(TranslatedChoice):
    def __init__(self, key, translated_text_fn):
        super().__init__(
            ...
            translated_text_fn,
            lambda: {
                settings.DictPopupHideOn.CLICK: tr("Click"),
                settings.DictPopupHideOn.DOUBLE_CLICK: tr("Double Click"),
                settings.DictPopupHideOn.LEAVE: tr("Leave Text Editor"),
                settings.DictPopupHideOn.ESCAPE: tr("Escape Key"),
                settings.DictPopupHideOn.NEVER: tr("None"),
            }, # fmt:skip
        )


class DictPositionMoveByChoice(TranslatedChoice):
    def __init__(self, key, translated_text_fn):
        super().__init__(
            key,
            translated_text_fn,
            lambda: {
                settings.DictPositionMoveBy.CHAR: tr("Character"),
                settings.DictPositionMoveBy.WORD: tr("Word"),
                settings.DictPositionMoveBy.DISABLED: tr("Disabled"),
            }, # fmt:skip
        )
...
class DictPopupShowOnChoice(TranslatedChoice):
    def __init__(self, key, translated_text_fn):
        super().__init__(
            ...
            translated_text_fn,
            lambda: {
                settings.DictPopupShowOn.CLICK: tr("Click"),
                settings.DictPopupShowOn.DOUBLE_CLICK: tr("Double Click"),
                settings.DictPopupShowOn.HOVER: tr("Hover Over"),
            }, # fmt:skip
        )


class DictSideBarSideChoice(TranslatedChoice):
    def __init__(self, key, translated_text_fn):
        super().__init__(
            key,
            translated_text_fn,
            lambda: {
                settings.DictSideBarSide.LEFT: tr("Left"),
                settings.DictSideBarSide.RIGHT: tr("Right"),
            },
        )


class DictSideBarUpdateOnChoice(TranslatedChoice):
    def __init__(self, key, translated_text_fn):
        super().__init__(
            key,
            translated_text_fn,
            lambda: {
                settings.DictSideBarUpdateOn.CLICK: tr("Click"),
                settings.DictPopupShowOn.DOUBLE_CLICK: tr("Double Click"),
                settings.DictPopupShowOn.HOVER: tr("Hover Over"),
            }, # fmt:skip
        )
...
class OpenSideChoice(TranslatedChoice):
    def __init__(self, key, translated_text_fn):
        super().__init__(
            key,
            translated_text_fn,
            lambda: {
                settings.OpenSide.LEFT_OF_SELECTED: tr(
                    "Left Of Selected Text"
                ),
                settings.OpenSide.RIGHT_OF_SELECTED: tr(
                    "Right Of Selected Text"
                ),
                settings.OpenSide.FAR_LEFT: tr("Far Left"),
                settings.OpenSide.FAR_RIGHT: tr("Far Right"),
            },
        )
