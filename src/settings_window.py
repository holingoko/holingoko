        ...
        self.widgets = [
            ...
            for class_, key, translated_text_fn in (
                ...
                (
                    ...
                    lambda: tr("Default Font Family"),
                ),
                (
                    settings_widgets.NaturalInt,
                    "text_editor_font_size",
                    lambda: tr("Default Font Size"),
                ),
                (
                    settings_widgets.FontWeightChoice,
                ...
                (
                    settings_widgets.OpenSideChoice,
                ...
                (
                    settings_widgets.Bool,
                    "text_editor_show_font_combo_box",
                    lambda: tr("Show Font Selection Combo Box"),
                ),
                (
    ...
    def __init__(self):
        ...
        self.widgets = [
            ...
            for class_, key, translated_text_fn in (
                ...
                (
                    settings_widgets.DictPositionMoveByChoice,
                ...
                (
                    ...
                    "dict_popup_show_on",
                    lambda: tr("Action To Show Popup"),
                ),
                (
                    settings_widgets.Length,
                ...
                (
                    settings_widgets.Bool,
                    "dict_side_bar_entry_preview_show",
                    lambda: tr("Show Entry Preview Side Bar"),
                ),
                (
                    settings_widgets.DictSideBarSideChoice,
                    "dict_side_bar_entry_preview_side",
                ...
                (
                    settings_widgets.Bool,
                    "dict_side_bar_hover_delay_skipped_on_click",
                    lambda: tr("Update Side Bar Without Hover Delay On Click"),
                ),
                (
                    settings_widgets.Length,
                    "dict_side_bar_min_width",
                    lambda: tr("Side Bar Minimum Width"),
                ),
                (
                    settings_widgets.DictPositionMoveByChoice,
                    "dict_side_bar_on_shortcut_move_by",
                    lambda: tr("On Move Side Bar Position Shortcut Keys, Move By"), # fmt:skip
                ),
                (
                    settings_widgets.Bool,
                    "dict_side_bar_on_shortcut_move_cursor",
                    lambda: tr("On Move Side Bar Position Shortcut Keys, Move Cursor Also"),  # fmt:skip
                ),
                (
                    settings_widgets.Length,
                    "dict_side_bar_position_marker_height",
                    lambda: tr("Side Bar Position Marker Height"),
                ),
                (
                    settings_widgets.Bool,
                    "dict_side_bar_position_marker_show",
                    lambda: tr("Show Text Editor Side Bar Position Marker"),
                ),
                (
                    settings_widgets.Length,
                    "dict_side_bar_position_marker_width",
                    lambda: tr("Side Bar Position Marker Width"),
                ),
                (
                    settings_widgets.Bool,
                    "dict_side_bar_text_editor_show",
                    lambda: tr("Show Text Editor Side Bar"),
                ),
                (
                    settings_widgets.DictSideBarSideChoice,
                    "dict_side_bar_text_editor_side",
                    lambda: tr("Text Editor Side Bar Side"),
                ),
                (
                    settings_widgets.DictSideBarUpdateOnChoice,
                    "dict_side_bar_update_on",
                    lambda: tr("Action To Update Side Bar"),
                ),
                (
                    settings_widgets.Length,
